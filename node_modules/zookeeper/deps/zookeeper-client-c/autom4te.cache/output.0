...
@%:@ Generated by GNU Autoconf 2.71 for zookeeper C client 3.6.3.
@%:@
...
PACKAGE_STRING='zookeeper C client 3.6.3'
...
if test "$ac_init_help" = "long"; then
  ...
  cat <<_ACEOF
\`configure' configures zookeeper C client 3.6.3 to adapt to many kinds of systems.
...
if test -n "$ac_init_help"; then
  case $ac_init_help in
     short | recursive ) echo "Configuration of zookeeper C client 3.6.3:";;
   esac
  cat <<\_ACEOF
...
if $ac_init_version; then
  cat <<\_ACEOF
zookeeper C client configure 3.6.3
...
It was created by zookeeper C client $as_me 3.6.3, which was
...
pkg_failed=no
{ printf "%s\n" "$as_me:${as_lineno-$LINENO}: checking for cppunit >= 1.10.2" >&5
printf %s "checking for cppunit >= 1.10.2... " >&6; }

if test -n "$CPPUNIT_CFLAGS"; then
    pkg_cv_CPPUNIT_CFLAGS="$CPPUNIT_CFLAGS"
 elif test -n "$PKG_CONFIG"; then
    if test -n "$PKG_CONFIG" && \
    { { printf "%s\n" "$as_me:${as_lineno-$LINENO}: \$PKG_CONFIG --exists --print-errors \"cppunit >= 1.10.2\""; } >&5
...
{ printf "%s\n" "$as_me:${as_lineno-$LINENO}: configuring SSL using --with-openssl=$with_openssl" >&5
printf "%s\n" "$as_me: configuring SSL using --with-openssl=$with_openssl" >&6;}
...
if test "x$with_openssl" != xno && test "x$have_openssl" = xno; then
    { printf "%s\n" "$as_me:${as_lineno-$LINENO}: WARNING: cannot build SSL support -- openssl not found" >&5
printf "%s\n" "$as_me: WARNING: cannot build SSL support -- openssl not found" >&2;}
    with_openssl=no
fi
if test "x$with_openssl" != xno; then
    { printf "%s\n" "$as_me:${as_lineno-$LINENO}: building with SSL support" >&5
printf "%s\n" "$as_me: building with SSL support" >&6;}
else
    { printf "%s\n" "$as_me:${as_lineno-$LINENO}: building without SSL support" >&5
printf "%s\n" "$as_me: building without SSL support" >&6;}
fi
 if test "x$with_openssl" != xno; then
  WANT_OPENSSL_TRUE=
  WANT_OPENSSL_FALSE='#'
...
as_ac_File=`printf "%s\n" "ac_cv_file_$srcdir/generated/zookeeper.jute.c" | $as_tr_sh`
{ printf "%s\n" "$as_me:${as_lineno-$LINENO}: checking for $srcdir/generated/zookeeper.jute.c" >&5
printf %s "checking for $srcdir/generated/zookeeper.jute.c... " >&6; }
...
@%:@define `printf "%s\n" "HAVE_$srcdir/generated/zookeeper.jute.c" | $as_tr_cpp` 1
_ACEOF
...
as_ac_File=`printf "%s\n" "ac_cv_file_$srcdir/generated/zookeeper.jute.h" | $as_tr_sh`
{ printf "%s\n" "$as_me:${as_lineno-$LINENO}: checking for $srcdir/generated/zookeeper.jute.h" >&5
printf %s "checking for $srcdir/generated/zookeeper.jute.h... " >&6; }
if eval test \${$as_ac_File+y}
then :
  printf %s "(cached) " >&6
else $as_nop
...
cat >>confdefs.h <<_ACEOF
@%:@define `printf "%s\n" "HAVE_$srcdir/generated/zookeeper.jute.h" | $as_tr_cpp` 1
_ACEOF
...
{ printf "%s\n" "$as_me:${as_lineno-$LINENO}: checking whether to enable gcov" >&5
printf %s "checking whether to enable gcov... " >&6; }
...
if test "x$with_syncapi" != xno && test "x$have_pthread" = xno; then
    { printf "%s\n" "$as_me:${as_lineno-$LINENO}: WARNING: cannot build SyncAPI -- pthread not found" >&5
printf "%s\n" "$as_me: WARNING: cannot build SyncAPI -- pthread not found" >&2;}
    with_syncapi=no
fi
if test "x$with_syncapi" != xno; then
    { printf "%s\n" "$as_me:${as_lineno-$LINENO}: building with SyncAPI support" >&5
printf "%s\n" "$as_me: building with SyncAPI support" >&6;}
else
    { printf "%s\n" "$as_me:${as_lineno-$LINENO}: building without SyncAPI support" >&5
printf "%s\n" "$as_me: building without SyncAPI support" >&6;}
fi
...
printf "%s\n" "@%:@define POLL_NFDS_TYPE nfds_t" >>confdefs.h

else $as_nop
  
printf "%s\n" "@%:@define POLL_NFDS_TYPE unsigned int" >>confdefs.h
...
{ printf "%s\n" "$as_me:${as_lineno-$LINENO}: checking whether SOCK_CLOEXEC is available" >&5
printf %s "checking whether SOCK_CLOEXEC is available... " >&6; }
...
if test "x$with_sock_cloexec" != xno && test "x$has_sock_cloexec" = xno; then
  { printf "%s\n" "$as_me:${as_lineno-$LINENO}: WARNING: cannot use SOCK_CLOEXEC -- SOCK_CLOEXEC undefined on this platform" >&5
printf "%s\n" "$as_me: WARNING: cannot use SOCK_CLOEXEC -- SOCK_CLOEXEC undefined on this platform" >&2;}
  with_sock_cloexec=no
fi

if test "x$with_sock_cloexec" != xno; then
{ printf "%s\n" "$as_me:${as_lineno-$LINENO}: building with SOCK_CLOEXEC" >&5
printf "%s\n" "$as_me: building with SOCK_CLOEXEC" >&6;}
else
{ printf "%s\n" "$as_me:${as_lineno-$LINENO}: building without SOCK_CLOEXEC" >&5
printf "%s\n" "$as_me: building without SOCK_CLOEXEC" >&6;}
fi

if test x"$with_sock_cloexec" != xno
then :
  
printf "%s\n" "@%:@define SOCK_CLOEXEC_ENABLED 1" >>confdefs.h
...
ac_log="
This file was extended by zookeeper C client $as_me 3.6.3, which was
generated by GNU Autoconf 2.71.  Invocation command line was
...
ac_cs_version="\\
zookeeper C client config.status 3.6.3
