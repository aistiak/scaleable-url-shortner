...
am__libzkmt_la_SOURCES_DIST = src/zookeeper.c include/zookeeper.h \
	...
	src/addrvec.c src/mt_adaptor.c
...
@WANT_SYNCAPI_TRUE@am_libzkmt_la_OBJECTS = $(am__objects_2) \
...
am__objects_4 = zktest_mt-TestDriver.$(OBJEXT) \
	...
	zktest_mt-TestServerRequireClientSASLAuth.$(OBJEXT)
@WANT_SYNCAPI_TRUE@nodist_zktest_mt_OBJECTS = $(am__objects_4) \
...
am__objects_5 = zktest_st-TestDriver.$(OBJEXT) \
	...
	zktest_st-TestServerRequireClientSASLAuth.$(OBJEXT)
...
am__depfiles_remade = ./$(DEPDIR)/addrvec.Plo ./$(DEPDIR)/cli.Po \
	./$(DEPDIR)/cli_mt-cli.Po ./$(DEPDIR)/hashtable.Plo \
	./$(DEPDIR)/hashtable_itr.Plo \
	./$(DEPDIR)/libzkmt_la-addrvec.Plo \
	./$(DEPDIR)/libzkmt_la-mt_adaptor.Plo \
	./$(DEPDIR)/libzkmt_la-recordio.Plo \
	./$(DEPDIR)/libzkmt_la-zk_hashtable.Plo \
	./$(DEPDIR)/libzkmt_la-zk_log.Plo \
	./$(DEPDIR)/libzkmt_la-zookeeper.Plo \
	./$(DEPDIR)/libzkmt_la-zookeeper.jute.Plo \
	./$(DEPDIR)/load_gen-load_gen.Po ./$(DEPDIR)/recordio.Plo \
	./$(DEPDIR)/st_adaptor.Plo ./$(DEPDIR)/zk_hashtable.Plo \
	./$(DEPDIR)/zk_log.Plo ./$(DEPDIR)/zktest_mt-LibCMocks.Po \
	./$(DEPDIR)/zktest_mt-LibCSymTable.Po \
	./$(DEPDIR)/zktest_mt-MocksBase.Po \
	./$(DEPDIR)/zktest_mt-PthreadMocks.Po \
	./$(DEPDIR)/zktest_mt-TestClient.Po \
	./$(DEPDIR)/zktest_mt-TestClientRetry.Po \
	./$(DEPDIR)/zktest_mt-TestDriver.Po \
	./$(DEPDIR)/zktest_mt-TestLogClientEnv.Po \
	./$(DEPDIR)/zktest_mt-TestMulti.Po \
	./$(DEPDIR)/zktest_mt-TestOperations.Po \
	./$(DEPDIR)/zktest_mt-TestReadOnlyClient.Po \
	./$(DEPDIR)/zktest_mt-TestReconfig.Po \
	./$(DEPDIR)/zktest_mt-TestReconfigServer.Po \
	./$(DEPDIR)/zktest_mt-TestServerRequireClientSASLAuth.Po \
	./$(DEPDIR)/zktest_mt-TestWatchers.Po \
	./$(DEPDIR)/zktest_mt-TestZookeeperClose.Po \
	./$(DEPDIR)/zktest_mt-TestZookeeperInit.Po \
	./$(DEPDIR)/zktest_mt-ThreadingUtil.Po \
	./$(DEPDIR)/zktest_mt-Util.Po ./$(DEPDIR)/zktest_mt-ZKMocks.Po \
	./$(DEPDIR)/zktest_mt-ZooKeeperQuorumServer.Po \
	./$(DEPDIR)/zktest_st-LibCMocks.Po \
	./$(DEPDIR)/zktest_st-LibCSymTable.Po \
	./$(DEPDIR)/zktest_st-MocksBase.Po \
	./$(DEPDIR)/zktest_st-TestClient.Po \
	./$(DEPDIR)/zktest_st-TestClientRetry.Po \
	./$(DEPDIR)/zktest_st-TestDriver.Po \
	./$(DEPDIR)/zktest_st-TestLogClientEnv.Po \
	./$(DEPDIR)/zktest_st-TestMulti.Po \
	./$(DEPDIR)/zktest_st-TestOperations.Po \
	./$(DEPDIR)/zktest_st-TestReadOnlyClient.Po \
	./$(DEPDIR)/zktest_st-TestReconfig.Po \
	./$(DEPDIR)/zktest_st-TestReconfigServer.Po \
	./$(DEPDIR)/zktest_st-TestServerRequireClientSASLAuth.Po \
	./$(DEPDIR)/zktest_st-TestWatchers.Po \
	./$(DEPDIR)/zktest_st-TestZookeeperClose.Po \
	./$(DEPDIR)/zktest_st-TestZookeeperInit.Po \
	./$(DEPDIR)/zktest_st-ThreadingUtil.Po \
	./$(DEPDIR)/zktest_st-Util.Po ./$(DEPDIR)/zktest_st-ZKMocks.Po \
	./$(DEPDIR)/zktest_st-ZooKeeperQuorumServer.Po \
	./$(DEPDIR)/zookeeper.Plo ./$(DEPDIR)/zookeeper.jute.Plo
am__mv = mv -f
...
@WANT_SYNCAPI_TRUE@libzkmt_la_CFLAGS = -DTHREADED
...
@WANT_SYNCAPI_TRUE@cli_mt_LDADD = libzookeeper_mt.la
@WANT_SYNCAPI_TRUE@cli_mt_CFLAGS = -DTHREADED
@WANT_SYNCAPI_TRUE@load_gen_SOURCES = src/load_gen.c
@WANT_SYNCAPI_TRUE@load_gen_LDADD = libzookeeper_mt.la
@WANT_SYNCAPI_TRUE@load_gen_CFLAGS = -DTHREADED
...
@WANT_SYNCAPI_TRUE@zktest_mt_LDADD = libzkmt.la libhashtable.la -lpthread $(CPPUNIT_LIBS) $(OPENSSL_LIB_LDFLAGS) -ldl
@WANT_SYNCAPI_TRUE@zktest_mt_CXXFLAGS = -DUSE_STATIC_LIB -DTHREADED $(CPPUNIT_CFLAGS) $(USEIPV6)
...
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/addrvec.Plo@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/cli.Po@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/cli_mt-cli.Po@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/hashtable.Plo@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/hashtable_itr.Plo@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/libzkmt_la-addrvec.Plo@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/libzkmt_la-mt_adaptor.Plo@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/libzkmt_la-recordio.Plo@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/libzkmt_la-zk_hashtable.Plo@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/libzkmt_la-zk_log.Plo@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/libzkmt_la-zookeeper.Plo@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/libzkmt_la-zookeeper.jute.Plo@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/load_gen-load_gen.Po@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/recordio.Plo@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/st_adaptor.Plo@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/zk_hashtable.Plo@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/zk_log.Plo@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/zktest_mt-LibCMocks.Po@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/zktest_mt-LibCSymTable.Po@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/zktest_mt-MocksBase.Po@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/zktest_mt-PthreadMocks.Po@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/zktest_mt-TestClient.Po@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/zktest_mt-TestClientRetry.Po@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/zktest_mt-TestDriver.Po@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/zktest_mt-TestLogClientEnv.Po@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/zktest_mt-TestMulti.Po@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/zktest_mt-TestOperations.Po@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/zktest_mt-TestReadOnlyClient.Po@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/zktest_mt-TestReconfig.Po@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/zktest_mt-TestReconfigServer.Po@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/zktest_mt-TestServerRequireClientSASLAuth.Po@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/zktest_mt-TestWatchers.Po@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/zktest_mt-TestZookeeperClose.Po@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/zktest_mt-TestZookeeperInit.Po@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/zktest_mt-ThreadingUtil.Po@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/zktest_mt-Util.Po@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/zktest_mt-ZKMocks.Po@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/zktest_mt-ZooKeeperQuorumServer.Po@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/zktest_st-LibCMocks.Po@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/zktest_st-LibCSymTable.Po@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/zktest_st-MocksBase.Po@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/zktest_st-TestClient.Po@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/zktest_st-TestClientRetry.Po@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/zktest_st-TestDriver.Po@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/zktest_st-TestLogClientEnv.Po@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/zktest_st-TestMulti.Po@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/zktest_st-TestOperations.Po@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/zktest_st-TestReadOnlyClient.Po@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/zktest_st-TestReconfig.Po@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/zktest_st-TestReconfigServer.Po@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/zktest_st-TestServerRequireClientSASLAuth.Po@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/zktest_st-TestWatchers.Po@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/zktest_st-TestZookeeperClose.Po@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/zktest_st-TestZookeeperInit.Po@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/zktest_st-ThreadingUtil.Po@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/zktest_st-Util.Po@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/zktest_st-ZKMocks.Po@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/zktest_st-ZooKeeperQuorumServer.Po@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/zookeeper.Plo@am__quote@ # am--include-marker
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/zookeeper.jute.Plo@am__quote@ # am--include-marker
...
zktest_mt-TestServerRequireClientSASLAuth.o: tests/TestServerRequireClientSASLAuth.cc
@am__fastdepCXX_TRUE@	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(zktest_mt_CXXFLAGS) $(CXXFLAGS) -MT zktest_mt-TestServerRequireClientSASLAuth.o -MD -MP -MF $(DEPDIR)/zktest_mt-TestServerRequireClientSASLAuth.Tpo -c -o zktest_mt-TestServerRequireClientSASLAuth.o `test -f 'tests/TestServerRequireClientSASLAuth.cc' || echo '$(srcdir)/'`tests/TestServerRequireClientSASLAuth.cc
@am__fastdepCXX_TRUE@	$(AM_V_at)$(am__mv) $(DEPDIR)/zktest_mt-TestServerRequireClientSASLAuth.Tpo $(DEPDIR)/zktest_mt-TestServerRequireClientSASLAuth.Po
@AMDEP_TRUE@@am__fastdepCXX_FALSE@	$(AM_V_CXX)source='tests/TestServerRequireClientSASLAuth.cc' object='zktest_mt-TestServerRequireClientSASLAuth.o' libtool=no @AMDEPBACKSLASH@
@AMDEP_TRUE@@am__fastdepCXX_FALSE@	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) @AMDEPBACKSLASH@
@am__fastdepCXX_FALSE@	$(AM_V_CXX@am__nodep@)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(zktest_mt_CXXFLAGS) $(CXXFLAGS) -c -o zktest_mt-TestServerRequireClientSASLAuth.o `test -f 'tests/TestServerRequireClientSASLAuth.cc' || echo '$(srcdir)/'`tests/TestServerRequireClientSASLAuth.cc

zktest_mt-TestServerRequireClientSASLAuth.obj: tests/TestServerRequireClientSASLAuth.cc
@am__fastdepCXX_TRUE@	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(zktest_mt_CXXFLAGS) $(CXXFLAGS) -MT zktest_mt-TestServerRequireClientSASLAuth.obj -MD -MP -MF $(DEPDIR)/zktest_mt-TestServerRequireClientSASLAuth.Tpo -c -o zktest_mt-TestServerRequireClientSASLAuth.obj `if test -f 'tests/TestServerRequireClientSASLAuth.cc'; then $(CYGPATH_W) 'tests/TestServerRequireClientSASLAuth.cc'; else $(CYGPATH_W) '$(srcdir)/tests/TestServerRequireClientSASLAuth.cc'; fi`
@am__fastdepCXX_TRUE@	$(AM_V_at)$(am__mv) $(DEPDIR)/zktest_mt-TestServerRequireClientSASLAuth.Tpo $(DEPDIR)/zktest_mt-TestServerRequireClientSASLAuth.Po
@AMDEP_TRUE@@am__fastdepCXX_FALSE@	$(AM_V_CXX)source='tests/TestServerRequireClientSASLAuth.cc' object='zktest_mt-TestServerRequireClientSASLAuth.obj' libtool=no @AMDEPBACKSLASH@
@AMDEP_TRUE@@am__fastdepCXX_FALSE@	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) @AMDEPBACKSLASH@
@am__fastdepCXX_FALSE@	$(AM_V_CXX@am__nodep@)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(zktest_mt_CXXFLAGS) $(CXXFLAGS) -c -o zktest_mt-TestServerRequireClientSASLAuth.obj `if test -f 'tests/TestServerRequireClientSASLAuth.cc'; then $(CYGPATH_W) 'tests/TestServerRequireClientSASLAuth.cc'; else $(CYGPATH_W) '$(srcdir)/tests/TestServerRequireClientSASLAuth.cc'; fi`
...
zktest_st-TestServerRequireClientSASLAuth.o: tests/TestServerRequireClientSASLAuth.cc
@am__fastdepCXX_TRUE@	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(zktest_st_CXXFLAGS) $(CXXFLAGS) -MT zktest_st-TestServerRequireClientSASLAuth.o -MD -MP -MF $(DEPDIR)/zktest_st-TestServerRequireClientSASLAuth.Tpo -c -o zktest_st-TestServerRequireClientSASLAuth.o `test -f 'tests/TestServerRequireClientSASLAuth.cc' || echo '$(srcdir)/'`tests/TestServerRequireClientSASLAuth.cc
@am__fastdepCXX_TRUE@	$(AM_V_at)$(am__mv) $(DEPDIR)/zktest_st-TestServerRequireClientSASLAuth.Tpo $(DEPDIR)/zktest_st-TestServerRequireClientSASLAuth.Po
@AMDEP_TRUE@@am__fastdepCXX_FALSE@	$(AM_V_CXX)source='tests/TestServerRequireClientSASLAuth.cc' object='zktest_st-TestServerRequireClientSASLAuth.o' libtool=no @AMDEPBACKSLASH@
@AMDEP_TRUE@@am__fastdepCXX_FALSE@	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) @AMDEPBACKSLASH@
@am__fastdepCXX_FALSE@	$(AM_V_CXX@am__nodep@)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(zktest_st_CXXFLAGS) $(CXXFLAGS) -c -o zktest_st-TestServerRequireClientSASLAuth.o `test -f 'tests/TestServerRequireClientSASLAuth.cc' || echo '$(srcdir)/'`tests/TestServerRequireClientSASLAuth.cc

zktest_st-TestServerRequireClientSASLAuth.obj: tests/TestServerRequireClientSASLAuth.cc
@am__fastdepCXX_TRUE@	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(zktest_st_CXXFLAGS) $(CXXFLAGS) -MT zktest_st-TestServerRequireClientSASLAuth.obj -MD -MP -MF $(DEPDIR)/zktest_st-TestServerRequireClientSASLAuth.Tpo -c -o zktest_st-TestServerRequireClientSASLAuth.obj `if test -f 'tests/TestServerRequireClientSASLAuth.cc'; then $(CYGPATH_W) 'tests/TestServerRequireClientSASLAuth.cc'; else $(CYGPATH_W) '$(srcdir)/tests/TestServerRequireClientSASLAuth.cc'; fi`
@am__fastdepCXX_TRUE@	$(AM_V_at)$(am__mv) $(DEPDIR)/zktest_st-TestServerRequireClientSASLAuth.Tpo $(DEPDIR)/zktest_st-TestServerRequireClientSASLAuth.Po
@AMDEP_TRUE@@am__fastdepCXX_FALSE@	$(AM_V_CXX)source='tests/TestServerRequireClientSASLAuth.cc' object='zktest_st-TestServerRequireClientSASLAuth.obj' libtool=no @AMDEPBACKSLASH@
@AMDEP_TRUE@@am__fastdepCXX_FALSE@	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) @AMDEPBACKSLASH@
@am__fastdepCXX_FALSE@	$(AM_V_CXX@am__nodep@)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(zktest_st_CXXFLAGS) $(CXXFLAGS) -c -o zktest_st-TestServerRequireClientSASLAuth.obj `if test -f 'tests/TestServerRequireClientSASLAuth.cc'; then $(CYGPATH_W) 'tests/TestServerRequireClientSASLAuth.cc'; else $(CYGPATH_W) '$(srcdir)/tests/TestServerRequireClientSASLAuth.cc'; fi`
...
distclean: distclean-am
	-rm -f $(am__CONFIG_DISTCLEAN_FILES)
		-rm -f ./$(DEPDIR)/addrvec.Plo
	-rm -f ./$(DEPDIR)/cli.Po
	-rm -f ./$(DEPDIR)/cli_mt-cli.Po
	-rm -f ./$(DEPDIR)/hashtable.Plo
	-rm -f ./$(DEPDIR)/hashtable_itr.Plo
	-rm -f ./$(DEPDIR)/libzkmt_la-addrvec.Plo
	-rm -f ./$(DEPDIR)/libzkmt_la-mt_adaptor.Plo
	-rm -f ./$(DEPDIR)/libzkmt_la-recordio.Plo
	-rm -f ./$(DEPDIR)/libzkmt_la-zk_hashtable.Plo
	-rm -f ./$(DEPDIR)/libzkmt_la-zk_log.Plo
	-rm -f ./$(DEPDIR)/libzkmt_la-zookeeper.Plo
	-rm -f ./$(DEPDIR)/libzkmt_la-zookeeper.jute.Plo
	-rm -f ./$(DEPDIR)/load_gen-load_gen.Po
	-rm -f ./$(DEPDIR)/recordio.Plo
	-rm -f ./$(DEPDIR)/st_adaptor.Plo
	-rm -f ./$(DEPDIR)/zk_hashtable.Plo
	-rm -f ./$(DEPDIR)/zk_log.Plo
	-rm -f ./$(DEPDIR)/zktest_mt-LibCMocks.Po
	-rm -f ./$(DEPDIR)/zktest_mt-LibCSymTable.Po
	-rm -f ./$(DEPDIR)/zktest_mt-MocksBase.Po
	-rm -f ./$(DEPDIR)/zktest_mt-PthreadMocks.Po
	-rm -f ./$(DEPDIR)/zktest_mt-TestClient.Po
	-rm -f ./$(DEPDIR)/zktest_mt-TestClientRetry.Po
	-rm -f ./$(DEPDIR)/zktest_mt-TestDriver.Po
	-rm -f ./$(DEPDIR)/zktest_mt-TestLogClientEnv.Po
	-rm -f ./$(DEPDIR)/zktest_mt-TestMulti.Po
	-rm -f ./$(DEPDIR)/zktest_mt-TestOperations.Po
	-rm -f ./$(DEPDIR)/zktest_mt-TestReadOnlyClient.Po
	-rm -f ./$(DEPDIR)/zktest_mt-TestReconfig.Po
	-rm -f ./$(DEPDIR)/zktest_mt-TestReconfigServer.Po
	-rm -f ./$(DEPDIR)/zktest_mt-TestServerRequireClientSASLAuth.Po
	-rm -f ./$(DEPDIR)/zktest_mt-TestWatchers.Po
	-rm -f ./$(DEPDIR)/zktest_mt-TestZookeeperClose.Po
	-rm -f ./$(DEPDIR)/zktest_mt-TestZookeeperInit.Po
	-rm -f ./$(DEPDIR)/zktest_mt-ThreadingUtil.Po
	-rm -f ./$(DEPDIR)/zktest_mt-Util.Po
	-rm -f ./$(DEPDIR)/zktest_mt-ZKMocks.Po
	-rm -f ./$(DEPDIR)/zktest_mt-ZooKeeperQuorumServer.Po
	-rm -f ./$(DEPDIR)/zktest_st-LibCMocks.Po
	-rm -f ./$(DEPDIR)/zktest_st-LibCSymTable.Po
	-rm -f ./$(DEPDIR)/zktest_st-MocksBase.Po
	-rm -f ./$(DEPDIR)/zktest_st-TestClient.Po
	-rm -f ./$(DEPDIR)/zktest_st-TestClientRetry.Po
	-rm -f ./$(DEPDIR)/zktest_st-TestDriver.Po
	-rm -f ./$(DEPDIR)/zktest_st-TestLogClientEnv.Po
	-rm -f ./$(DEPDIR)/zktest_st-TestMulti.Po
	-rm -f ./$(DEPDIR)/zktest_st-TestOperations.Po
	-rm -f ./$(DEPDIR)/zktest_st-TestReadOnlyClient.Po
	-rm -f ./$(DEPDIR)/zktest_st-TestReconfig.Po
	-rm -f ./$(DEPDIR)/zktest_st-TestReconfigServer.Po
	-rm -f ./$(DEPDIR)/zktest_st-TestServerRequireClientSASLAuth.Po
	-rm -f ./$(DEPDIR)/zktest_st-TestWatchers.Po
	-rm -f ./$(DEPDIR)/zktest_st-TestZookeeperClose.Po
	-rm -f ./$(DEPDIR)/zktest_st-TestZookeeperInit.Po
	-rm -f ./$(DEPDIR)/zktest_st-ThreadingUtil.Po
	-rm -f ./$(DEPDIR)/zktest_st-Util.Po
	-rm -f ./$(DEPDIR)/zktest_st-ZKMocks.Po
	-rm -f ./$(DEPDIR)/zktest_st-ZooKeeperQuorumServer.Po
	-rm -f ./$(DEPDIR)/zookeeper.Plo
	-rm -f ./$(DEPDIR)/zookeeper.jute.Plo
	-rm -f Makefile
